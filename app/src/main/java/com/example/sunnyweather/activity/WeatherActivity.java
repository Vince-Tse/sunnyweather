...
public class WeatherActivity extends Activity implements View.OnClickListener{
    public static final String WEATHER_KEY = "450f08bc221248e4910cee32275616f2";
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.switch_city:
                ...
                intent.putExtra("from_weather_acvitity",true);
     ...
     */
    private void queryFromServer(final String address,final String response ){
